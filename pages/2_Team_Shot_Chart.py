...
def get_selected_games(games_selected, team_data_filtered):
     ...
     data_from_game_selected['OPP'] = (data_from_game_selected['U_ID']
                                       .str
                                       .split(' - ')
                                       .str[0]
     )
     data_from_game_selected['DATE'] = (data_from_game_selected['U_ID']
                                        .str
                                        .split(' - ')
                                        .str[1]
     )
...
if games_selected:
    ...
    st.markdown("<h1 style='text-align: center; color: black;'>Shot Chart</h1>", 
                unsafe_allow_html=True
    )
    st.plotly_chart(fig, use_container_width=True)
    st.markdown("<h1 style='text-align: center; color: black;'>Top 5 Spots</h1>", 
                unsafe_allow_html=True
    )
