...
players_selected = st.multiselect(label='Choose Player', 
...
if players_selected:
    ...
    fig.update_layout(
            ...
            shapes=[
                ...
                dict(type="path",
                    path=ellipse_arc(a=200.5, b=200.5, start_angle=0.0, end_angle=np.pi - 0.0, N=5000),#start_angle=0.386283101, end_angle=np.pi - 0.386283101),
                    line=dict(color=main_line_col, width=1), layer='below'),
                dict(
                    type="line", x0=-200.5, y0=-52.5, x1=-200.5, y1=threept_break_y,
